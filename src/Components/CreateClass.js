...
function CreateClass({ close }) {
  const [partnerLogo, setPartnerLogo] = useState();
  const [createClass, setCreateClass] = useState({
    name: "jss1 A",
    description: "class jss1 A for jss1 student",
    teachers: ["66276fdd0d1f22ec806d155f"],
  });
    ...
    <NewPartner>
      <Modal>
        ...
        <LabelinputLayout
          ...
          value={createClass.teachers}
          onChange={(e) => {
            setCreateClass((prev) => {
              return { ...prev, teachers: e.target.value };
            });
          }}
        />
        {/* <LabelinputLayout
